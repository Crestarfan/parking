...
public sealed class FilterRequestModel
{
...
public sealed class FilterResponseModel
{
    public List<SearchResultModel> Results { get; set; } = [];
    public DateTime? LastUpdateTime { get; set; }
    public int TotalFound { get; set; }
...
public sealed class CarparkDetailResponseModel
{
    public string CarParkNo { get; set; } = string.Empty;
    public string Address { get; set; } = string.Empty;
...
public sealed class DataStatusResponseModel
{
